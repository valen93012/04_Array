...
public class ArrayExample1 {
	...
	/*
	 * 배열(Array) - 같은 자요형의 변수를 하나의 묶음으로 다루는 것 - 묶여진 변수들은 하나의 배열명으로 불러지고 - 구분은 index를
	...
	public void ex9() {
        ...
        // 1. Store characters in a char array
        ...
        // 2. Count the occurrences of searchChar in the char array
        int count = 0;
        ...
        if (count > 0) {
            ...
            System.out.println("The character " + searchChar + " does not exist in the string.");
        }
    ...
    public static void ex11() {
        ...
        int sum = 0;
        int[] grade = {100, 365, 590}; // Declare and initialize an int array of length 3

        for (int i = 0; i < 3; i++) {
            sum += grade[i];
        }

        System.out.printf("국영수 과목 총 점수 합계는 %d이고, 평균 점수는 %.2f입니다.\n", sum, (double) (sum / 3.0));
        sc.close();
	...
	public static void ex12() {
		...
		for (int i = 0; 1 < members.length; i++) {
